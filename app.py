...
app = Flask(__name__)
app.secret_key = "admin123_secret_key"
...
<header>
  ...
  <nav><a href="/">Dashboard</a><a href="https://www.nseindia.com/market-data/live-equity-market" target="_blank">More Stocks</a></nav>
...
<div class="container">
  ...
  <a href="https://www.nseindia.com/market-data/live-equity-market" target="_blank" class="btn">Scan More Stocks on NSE</a>
...
@app.route("/dashboard")  # <-- YE NAYA LINE ADD KIYA
def login():
